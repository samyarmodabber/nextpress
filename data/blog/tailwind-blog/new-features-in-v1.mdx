...
layout templates are stored in the `@/components/layouts` folder. You can add your React components that you want to map to markdown content in this folder.
