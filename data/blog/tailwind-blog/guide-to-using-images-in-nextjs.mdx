...
Assuming we have a file called `ocean.jpg` in `static/images/blog/ocean.jpg`, the following line of code would generate the optimized image.

```
![ocean](/static/images/blog/ocean.jpg)
```
...
```js
<Image alt="ocean" src="/static/images/blog/ocean.jpg" width={256} height={128} />
```

_Note_: If you try to save the image, it is in webp format, if your browser supports it!

![ocean](/static/images/blog/ocean.jpeg)
...
- All images have to be stored in the `public` folder e.g `/static/images/blog/ocean.jpeg`
